        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  ...
                  <a href="{{route('admin.question.add')}}" class="btn btn-primary float-sm-right  " role="button" aria-disabled="true">Add Question</a>
                    ...
                    <tbody>
                        @php
                            ...
                            @foreach ($questions as $question)
                                <tr>
                                    <th>{{$count}}</th>
                                    <td class="text-lowercase">{{$question->code}}</td>
                                    <td class="text-lowercase">{{$question->question}}</td>
                                </tr>
                                @php
                                    $count++;
                                @endphp
